...
```text
帮我安装 DSH 安全市场：用官方命令 `dsh plugin --profile web add https://github.com/bruc3van/dsh-desktop-safe-market/archive/refs/tags/v0.2.12.tar.gz` 装进 web profile，完成后提醒我重启 dsh web 才会生效。
```
