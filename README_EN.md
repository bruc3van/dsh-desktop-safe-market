...
```text
Install the DSH plugin market for me: run the official command `dsh plugin --profile web add https://github.com/bruc3van/dsh-desktop-safe-market/archive/refs/tags/v0.2.2.tar.gz` into the web profile, then remind me to restart dsh web for it to load.
```
