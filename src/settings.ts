...
export const SAFE_MARKET_NAMESPACE = settingsNamespace('safe-market')
 ...
 */
export const SafeMarketSettingsSchema: z<SafeMarketSettings> = z.object({
 ...
 */
export function registerSafeMarketSettings(ctx: Context): SettingsScope<SafeMarketSettings> {
